;;; sv-kalender-namnsdagar.el --- Swedish name day calendar -*- lexical-binding: t; -*-
...
(defconst sv-kalender-namnsdagar-name-list-2001-with-some-updates
  ...
  "Swedish name day according to the 2001 revision.
Some updates before 2022 revision has been added."
  )
...
(defun sv-kalender-namnsdagar--pretty-name (name-info)
  ...
  (cond ((stringp name-info) name-info)
        (t (car name-info))))

(cl-defstruct sv-kalender-namnsdagar-name
  (name nil :read-only t :type string :documentation "The name")
  (extended nil :read-only t :type boolean :documentation "Non-nil if part of the extended name set")
  (introduced nil :read-only t :type int :documentation "The year the name was introduced"))
